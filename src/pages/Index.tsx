      ...
      <header className="border-b bg-white/80 backdrop-blur-sm sticky top-0 z-50">
        <div className="container mx-auto px-6 py-4 flex justify-between items-center">
          ...
          <nav className="hidden md:flex space-x-8">
            <a href="#services" className="text-gray-600 hover:text-pink-500 transition-colors">Услуги</a>
            <a href="#portfolio" className="text-gray-600 hover:text-pink-500 transition-colors">Портфолио</a>
            <a href="#prices" className="text-gray-600 hover:text-pink-500 transition-colors">Цены</a>
            <a href="#about" className="text-gray-600 hover:text-pink-500 transition-colors">О мастере</a>
            <a href="#contact" className="text-gray-600 hover:text-pink-500 transition-colors">Контакты</a>
          </nav>
      ...
      <section className="py-20 px-6">
        <div className="container mx-auto text-center">
          ...
          <h1 className="text-5xl md:text-6xl font-bold text-gray-800 mb-6">
            Красота ваших
            <span className="text-pink-500 block">ногтей</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Button size="lg" variant="outline" className="border-pink-500 text-pink-500 hover:bg-pink-50 px-8">
        ...
        <div className="container mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <Icon name="Scissors" size={32} className="text-pink-500 mb-4" />
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <Icon name="Palette" size={32} className="text-pink-500 mb-4" />
            ...
            <Card className="hover:shadow-lg transition-shadow">
              <CardHeader>
                <Icon name="GraduationCap" size={32} className="text-pink-500 mb-4" />
            ...
            {[1, 2, 3, 4, 5, 6].map((item) => (
              <div key={item} className="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
                <div className="aspect-square bg-gradient-to-br from-pink-100 to-rose-100 flex items-center justify-center">
                  <Icon name="Image" size={48} className="text-pink-300" />
                </div>
                <div className="p-4">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <Card className="relative overflow-hidden">
              <CardHeader>
                ...
                <div className="text-3xl font-bold text-pink-500">1500₽</div>
              </CardHeader>
              <CardContent>
            ...
            <Card className="relative overflow-hidden border-2 border-pink-500">
              <div className="absolute top-0 right-0 bg-pink-500 text-white px-3 py-1 text-sm">
                Популярно
              </div>
              <CardHeader>
                <CardTitle>Маникюр + дизайн</CardTitle>
                <div className="text-3xl font-bold text-pink-500">2500₽</div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-center">
            ...
            <Card className="relative overflow-hidden">
              <CardHeader>
                ...
                <div className="text-3xl font-bold text-pink-500">15000₽</div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3">
                  <li className="flex items-center">
      ...
      <section id="about" className="py-16 px-6 bg-gray-50">
        <div className="container mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="bg-gradient-to-br from-pink-100 to-rose-100 rounded-2xl aspect-square flex items-center justify-center">
              <Icon name="User" size={120} className="text-pink-300" />
            </div>
          </div>
        </div>
      </section>
            ...
            <div>
              ...
              <div className="space-y-4">
                <div className="flex items-center">
                  <Icon name="Phone" size={20} className="text-pink-500 mr-4" />
                  <span>+7 (999) 123-45-67</span>
                </div>
                <div className="flex items-center">
                  <Icon name="Mail" size={20} className="text-pink-500 mr-4" />
                  <span>anna@nailart-studio.ru</span>
                </div>
                <div className="flex items-center">
                  <Icon name="MapPin" size={20} className="text-pink-500 mr-4" />
                  <span>г. Москва, ул. Красивая, д. 15</span>
                </div>
                <div className="flex items-center">
                  <Icon name="Clock" size={20} className="text-pink-500 mr-4" />
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div>
                  ...
                  <select className="w-full mt-1 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-pink-500">
